        ...
        <section className="instruo-about">
            ...
            <section className="about-card-wrapper">
                <section className="about-card" about="instruo">
                    <div className="heading">Instruo 14</div>
                    <p>
                    ...
                    <div>
                        <h3>Mission</h3>
                        <p>
                            INSTRUO plans to achieve a new clean and clear concept of new innovations worldwide and give
                            the young minds a platform to showcase their learnings and teamwork through multiple
                            technical events and activities for this edition we will focus on new events of metaverse
                    ...
                    <div>
                        <h3>Vision</h3>
                        <p>
                            Since its inception, INSTRUO has always strived towards the goal of exploring ground
                            breaking innovations! The upcoming edition of INSTRUO will only reinforce this very ideology
                            and maneuver in bringing society closer in aspects of technology and innovation. The very
                            crux of INSTRUO 2025 is to provide opportunities to learn and explore the vastness of
                            science and to learn technology and strive for a better tomorrow.
                        </p>
                    </div>
                </section>
