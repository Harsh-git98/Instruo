...
output_dir = './client/public/assets/Team'
...
count = 0
allFiles = os.listdir('./client/public/assets/Team')
print(allFiles)
...
for filename in allFiles:
    ...
    if not filename.lower().endswith('.webp') and not filename.lower().endswith('.py'):
        ...
        newchanges.append(newName)
        output_path = os.path.join(output_dir, os.path.splitext(newName)[0] + '.webp')
